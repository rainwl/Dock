...
namespace MRTK.Tutorials.MultiUserCapabilities
{
    public class PhotonRoom : MonoBehaviourPunCallbacks, IInRoomCallbacks
    {
        ...
        [SerializeField] private GameObject photonUserPrefab = default;//联机用户预制体
        [SerializeField] private GameObject roverExplorerPrefab = default;//加载的模型预制体
        [SerializeField] private Transform roverExplorerLocation = default;//加载位置
